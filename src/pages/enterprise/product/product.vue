		...
		<el-collapse v-model='activeCollapse'>
			<el-collapse-item title='查询条件' name='search'>
				<el-form ref='searchCondition' :model='filter' label-width='80px' label-position=‘left’>
					<el-row>
						<el-col :span='6'>
							<el-form-item label='产品名称' prop='studentName'>
			...
			<div>
				<div style='margin-bottom: 20px'>
					<el-table :data='studentData' width='100%' border>
						...
						<el-table-column label='产品编号' prop='studentNo' width='200' align="center"></el-table-column>
						<el-table-column label='产品名称' prop='studentName' width='200' align="center"></el-table-column>
						<el-table-column label='销售状态' prop='gradge' width='200' align="center"></el-table-column>
